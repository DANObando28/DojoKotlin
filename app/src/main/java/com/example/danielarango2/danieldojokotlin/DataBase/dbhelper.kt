package com.example.danielarango2.danieldojokotlin.DataBase
...
/**
 * Created by Daniel.arango2 on 25/08/18.
 */
...
class dbhelper(var context :Context) : SQLiteOpenHelper(context, DATABASE_NAME,null, DATABASE_VERSION){
    ...
    fun insertNote (note : Note){
        ...
        if(resultado === -1.toLong()){
            ...
            Toast.makeText(context, "creada la nota", Toast.LENGTH_SHORT).show()
        }
    ...
    fun getNotes() : MutableList<Note>
    {
        ...
        var notas : MutableList<Note> = ArrayList()
